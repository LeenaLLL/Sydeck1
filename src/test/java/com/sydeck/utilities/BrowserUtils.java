...
public class BrowserUtils {
    ...
    /*******************************************************
     * Extracts text from list of elements matching
     * the provided locator into new List<String>
     * @param locator
     ...
     * @return
     */
    public static WebElement waitForVisibility(By locator,long timeToWaitInSec){
        WebDriverWait wait=new WebDriverWait(Driver.get(),timeToWaitInSec);
        return wait.until(ExpectedConditions.visibilityOf(Driver.get().findElement(locator)));
