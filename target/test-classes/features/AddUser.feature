...
Feature:
	...
	Scenario: US05_TC01_Add new user
		...
		When the user clicks the "Users" button on the dashboard page
	...
	#4-Status should have ACTIVE and INACTIVE
	@SYD-293 @SYD-287
	Scenario Outline: US05_TC10_Mandatory Fields
	...
	Scenario: US06_TC11_Selecting date in calendar
		...
		When "2021-03-25" is selected in calender
		Then "2021-03-25" should get displayed in the date field.
	...
	Scenario: US05_TC14_Cancel the data
		 Scenario: Librarian can cancel new user
	...
	Scenario Outline: US05_TC15_Fullname Validation
		...
		When the user clicks the "Users" button on the dashboard page
		And the user clicks the Add User button
		When the user enters invalid "<full name>" as fullname
